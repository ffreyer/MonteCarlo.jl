...
"""
    load_measurement(data, ::Type{<: AbstractMeasurement})

Loads a measurement from a data dictionary generated by `save_measurement` for
the given measurement type.
"""
function load_measurement(data, ::DataType)
    # NOTE
    # something saved as `write(f, entryname * "path/to/data")` is reachable
    # by `data["path"]["to"]["data"]` here
