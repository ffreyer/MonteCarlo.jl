...
"""
@inline function prepare_observables(mc::DQMC, m::ZCModel)
...
"""
    measure_observables!(m::ZCModel, obs::Dict{String,Observable}, conf::HubbardConf, E::Float64)
...
"""
@noinline function measure_observables!(mc::DQMC, m::ZCModel,
...
"""
    measure_observables!(mc::DQMC, m::ZCModel, obs::Dict{String,Observable})

Finish measurements of observables.

See also [`prepare_observables`](@ref) and [`measure_observables!`](@ref).
"""
@inline function finish_observables!(mc::DQMC, m::ZCModel,
							obs::Dict{String,Observable})
    nothing
end
